 ...
 * It normalizes the readings by intensity, and identifies colour on the Serial Monitor.
 *
 * Author: D. Dubins
 * Date: 18-Dec-24
...
colour decodeColour(int colourArr[4]) {  // decodes an RGB sensor reading into colour buckets defined in the enum "colour".
  ...
  const float ORANGE_THRESHOLD = 0.4;                                                                         // this is the GREEN threshold for orange
